...
st.markdown("""
    <style>
        ...
        /* Cajas de Insights explicativos */
        .insight { 
            background-color: #1c2030; border-left: 4px solid #4eb1cb; 
            border-radius: 0 8px 8px 0; padding: 14px 18px; 
            margin: 15px 0; font-size: 14px; color: #e8eaf2;
        }
        .insight.warn { border-left-color: #f9c74f; }
        .insight.danger { border-left-color: #f8961e; }
        
        /* 🚀 NUEVO: Tamaño de letra de los TABS (Pestañas) */
        button[data-baseweb="tab"] p {
            font-size: 20px !important; /* Letra más grande */
            font-weight: bold !important; /* Letra en negrita */
        }
        
        /* 🚀 NUEVO: Tamaño de letra de los Títulos de los KPIs */
        [data-testid="stMetricLabel"] p {
            font-size: 16px !important; /* Letra más grande para el título */
            color: #b0b5c9 !important; /* Un gris clarito elegante */
        }
        
        /* Opcional: Si querés que el número del KPI sea un poquito más grande */
